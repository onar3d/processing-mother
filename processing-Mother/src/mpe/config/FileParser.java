/*
This class is part of the MostPixelsEver open source project, Copyright Daniel Shiffman.
It was included here with permission from the authors, and is distributed under the same license 
as that applying to the complete MostPixelsEver project, GPL 3.
For more details, see <http://code.google.com/p/mostpixelsever/> 
*/
